            ...
            <div className="footer-container">
                <div className="footer-brand">
                    ...
                    <p className="footer-about">
                        Experience the raw beauty of the Himalayas with our
                        curated adventures, comfortable stays, and trusted
                        transport services.
                    </p>
                ...
                <div className="footer-links-group">
                    ...
                    <ul className="footer-links">
                        <li>
                            <span className="footer-icon">Phone: </span>+91
                            95364 89063
                        </li>
                        <li>
                        ...
                        <li>
                            <span className="footer-icon">E-Mail: </span>
                            contact@tripdhara.com
                        </li>
                    </ul>
                </div>
            ...
            <div className="footer-bottom">
                ...
                <div className="footer-bottom-flex">
                    <p className="footer-copyright">
                        &copy; 2026 Tripdhara. All rights reserved.
                    </p>
